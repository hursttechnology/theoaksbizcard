  ...
  <div class="checklistItem mt-6 mx-2 flex items-center">
    <div class="relative" style="line-height: 0">
      <input
        ...
        class="checkbox cursor-pointer appearance-none bg-black h-12 w-12 border-transparent rounded border transition-colors duration-200 checked:bg-slate-600 checked:border-pink-600 focus:outline-none"
        :class="
